      ...
      <nav className="container flex items-center justify-between py-4" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            <span className="text-xl font-bold text-primary-600">YouTube Gesture Controller</span>
          </a>
        </div>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="https://github.com/yourusername/youtube-gesture-controller" className="btn">
            View on GitHub
          </a>
        </div>
      </nav>
